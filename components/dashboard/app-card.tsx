...
export function AppCard({
  ...
  return (
    <motion.div
      ...
      whileHover={{ y: -3 }}
      className="group flex flex-col gap-3 rounded-2xl border border-border bg-surface p-4 shadow-sm transition-shadow hover:shadow-lg hover:shadow-black/5"
    >
      <div className="flex items-start gap-2">
        ...
        >
          ...
          <span className="min-w-0 flex-1">
            <span className="flex items-start gap-1 font-display text-sm font-semibold text-foreground">
              <span title={app.name} className="line-clamp-2 break-words">
                {app.name}
              </span>
              <ArrowUpRight
                size={13}
